...
- Step 5 is the latest root version.
...
- Recommendation flow is: load catalog -> merge manual profile and current behavior profile -> filter inventory -> score -> return ranked products.
...
- Step 6: persist products and current user behavior with SQLite while preserving existing APIs.
