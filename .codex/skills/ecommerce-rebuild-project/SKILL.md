...
- Step 7 is the latest root version.
...
- Step 7 note exists at `steps/step-07-supervisor-agent-skeleton/README.md`.
...
- Recommendation flow is: FastAPI -> Supervisor -> UserProfileAgent + ProductRecAgent -> ProductRecAgent rerank + InventoryAgent -> MarketingCopyAgent -> response.
